    ...
    <>
      ...
      <div className="hidden">
        <div ref={componentRef} className="p-8">
          ...
          <div className="w-full bg-background h-full px-4 pt-3 pb-6 flex-1">
                ...
                {data.bill_details.details.length > 0 && (
                  <>
                    ...
                    <div className=" mt-4 space-y-4">
                      ...
                      <div className="flex justify-between w-full">
                        <p className="text-muted-foreground text-sm">Tagihan</p>
                        <div>
                          <p>{priceMask(data.price)}</p>
                        </div>
                      </div>
          ...
          {data.payment_information ? (
            <>
              <div className="w-full bg-background h-full pt-4 flex-1 relative overflow-clip">
                <div className="px-4">
                  <p className="font-medium text-lg text-primary">
                    Rincian Pembayaran
                  </p>
                ...
                <div className="w-full bottom-0 mt-6">
                  <div className="bg-amber-50 flex items-center space-x-2 text-amber-800 px-4 py-1.5">
                    <InfoCircledIcon />
                    <p className="text-xs">
          ...
          <div className="flex flex-row justify-stretch items-center mt-2">
            <div className="space-y-4 w-full gap-3 h-full mt-1"></div>
          </div>
        </div>
      </div>
    </>
